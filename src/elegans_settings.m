...
CFG.train_params = { ...
  [0.1],   [1.5],   [0.05],  [-1], 'QP', [1]; ...  % max amount of train data available without val data
...
CFG.PAR.num_levels = 7; % something like 3-10;
...
% competitor
CFG.cufflinks_pred_file = sprintf('%selegans.%s.cufflinks.mat', data_dir, '6.bestpaired.filtered');
