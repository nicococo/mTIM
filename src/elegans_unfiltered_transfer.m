function CFG = elegans_unfiltered_transfer_settings(CFG)
...
CFG.train_params = { ...
  [2.5],   [0.5],   [0.05],  [25], 'QP', [1]; ...  % max amount of train data available without val data
};
...
CFG.PAR.num_plif_nodes = 10; %CFG.PAR.num_levels+2 %2*CFG.PAR.num_levels;
...
%CFG.INFO=['Disabled permitted feature ranges for expr models'...
%'>=7 since there was an error while decoding.'];
...
foo = load([CFG.out_dir 'dros_final.mat']);
