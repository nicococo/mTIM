...
CFG.PAR.labels2states_exon_win = 80;
...
CFG.PAR.num_levels = 3; % something like 3-10;
...
CFG.PAR.gene_states_low_cover_cutoff = 13; % a value of 10 corresponds to a block
...
data_dir = '/home/nico/mtim/mini/';
genome_dir = [data_dir 'mini.gio'];
anno_dir = [data_dir];
...
read_map_file = [read_map_dir 'mini.filtered.bam'];
